...
def DisplayRecentScores(RecentScores):
  ...
  Name = "Name"
  Score = "Score"
  print("{0:<9}{1:>9}".format(Name,Score))
  for Count in range(1, NO_OF_RECENT_SCORES + 1):
    print("{0:<9}{1:>9}".format(RecentScores[Count].Name,RecentScores[Count].Score))
  print()
...
def UpdateRecentScores(RecentScores, Score):
  PlayerChoice = input("Do you want to add your score to the high score table? (y or n): ")
